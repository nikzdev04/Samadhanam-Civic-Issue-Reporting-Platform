...
import 'package:helpcivic/features/home/widgets/news_ticker.dart';
import 'package:helpcivic/mongodb.dart'; // Import to get user data and loggedInUserId
// Import the ChatScreen file to use it in the modal
import 'package:helpcivic/features/chat/chat_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // NEW METHOD TO SHOW THE CHAT BOT AS A DIALOG
  void _showChatbotModal(BuildContext context) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return Dialog(
          // Use large padding to ensure the modal takes up most of the screen space
          insetPadding: const EdgeInsets.all(16.0),
          child: ClipRRect(
            borderRadius: BorderRadius.circular(16.0),
            // The ChatScreen is placed inside the dialog
